...
hound.displayCategorias = function() {
	$("#listCatalogos").html("");
	var template = Handlebars.compile($('#listCategoriasTemplate').html());
	var contenido = "";
...
hound.displayContactos = function() {
	$("#listContactos").html("");
	var template = Handlebars.compile($('#listContactosTemplate').html());
...
hound.displayArticulos = function() {
	$("#listArticulos").html("");
	var template = Handlebars.compile($('#listArticulosTemplate').html());
...
hound.displayArticulo = function() {
	...
	var template = Handlebars.compile($('#articuloTemplate').html());
...
hound.displayPromociones = function() {
	...
	var template = Handlebars.compile($('#listPromocionesTemplate').html());
...
hound.displayPromocion = function() {
	...
	var template = Handlebars.compile($('#promocionTemplate').html());
...
hound.displayEncuestas = function() {
	...
	$("#listEncuestas").html("");
	var template = Handlebars.compile($('#listEncuestasTemplate').html());
...
hound.displayEncuesta = function() {
	...
	var template = Handlebars.compile($('#encuestaTemplate').html());
...
hound.displayTiendas = function() {
	...
	var template = Handlebars.compile($('#listTiendasTemplate').html());
